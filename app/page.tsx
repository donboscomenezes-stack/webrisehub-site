...
function AppShell() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(188,162,104,0.18),transparent_30%),linear-gradient(135deg,var(--background),var(--surface-deep))] text-foreground">
      {view === 'home' && (
        <HomePage
          stats={stats}
